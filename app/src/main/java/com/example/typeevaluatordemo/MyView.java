...
public class MyView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        canvas.drawLine(30, 30, 1010, 30, mPaint);
        canvas.drawLine(30, 30, 30, 1488, mPaint);
        canvas.drawLine(30, 1488, 1010, 1488, mPaint);
        canvas.drawLine(1010, 30, 1010, 1488, mPaint);
        ...
        if (currentPoint == null) {
            ...
            animator.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    //end = randomPoint();
                    //Log.d("YAG", "onAnimationEnd: "+start1.getX());
    ...
    private Point randomPoint() {
        ...
        float randomHeigh = random.nextInt(1319) + 100;
        float randomWith = random.nextInt(841) + 100;
    ...
    private void calculateXY(Point start, float k, int flag, Point end) {
        float y = (rangeHeight - start.getY());//0
